...
tb = keras.callbacks.TensorBoard(log_dir="./logs/base/encoding_classifier/".format(NEW))
'''
...
model_saver = ModelSaver(
    classifier=model.classifier, path="./models/base/encoding_classifier.h5".format(NEW)
)
