...
train_split1 = train_split.iloc[600:]
val_split1 = val_split.iloc[200:]
test_split1 = test_split.iloc[200:]


datagen = ImageDataGenerator(rescale=1.0 / 255)
train_generator = datagen.flow_from_dataframe(
    dataframe=train_split1,
...
tb = keras.callbacks.TensorBoard(log_dir="./logs/Xray6/autoencoder_Xray_base2/")
chkpnt = keras.callbacks.ModelCheckpoint(
    filepath="./models/Xray6/autoencoder_Xray_base2.h5",
    monitor="val_loss",
    save_best_only=True,
...
recon_sampler = Reconstruction(
    ...
    n_images=5,
    model_dir=MODEL_DIR,
    output_dir="./results/base_split2/",
...
ae.model.compile(
    ...
    optimizer=keras.optimizers.Adam(lr=1e-3), loss="mse", metrics=["mae", "mse"]
...
history = ae.model.fit(
    ...
    epochs=EPOCHS,
    steps_per_epoch=len(train_split1) // BATCH_SIZE,
    validation_steps=len(val_split1) // BATCH_SIZE,
...
plt.savefig('Learning_Curve_loss_autoencoder_Xray6_split2_base.png')