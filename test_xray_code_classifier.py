...
# CLASSIFIER_WEIGHTS_PATH = "./models/Xray6/encoding_disease_classifier.h5".format(NEW)
CLASSIFIER_WEIGHTS_PATH = "./models/Xray6/encoding_gender_classifier.h5".format(NEW)
...
plt.legend(loc='best')
# plt.savefig('./plots/ROC_AUC_plot_2diseaselabels_gender2disease_code_d.png')
plt.savefig('./plots/ROC_AUC_plot_2diseaselabels_gender2disease_code_g.png')

# print("Accuracy is :", accuracy)
# fpr_keras, tpr_keras, thresholds_keras = roc_curve(test_generator.classes, roc_preds)
# auc_keras = auc(fpr_keras, tpr_keras)
#
# plt.figure(1)
# plt.plot([0, 1], [0, 1], 'k--')
...
# plt.title('ROC curve for gender model disease Prediction')
# plt.legend(loc='best')
# plt.savefig('./plots/ROC_AUC_plot_2diseaselabels_gender2disease_pred.png')
