...
DECODER_WEIGHTS_PATH = "./models/Xray6/decoder.h5".format(NEW)
...
model = models.AutoencoderClassifier(
...
plt.legend(loc='best')
# plt.savefig('./plots/ROC_AUC_plot_2diseaselabels_gen0000der2disease_autoencoder_model3_d.png')
plt.savefig('./plots/ROC_AUC_plot_2diseaselabels_gender2disease_autoencoder_model3_g.png')
