...
Z_DIM = 512
ENCODER_WEIGHTS_PATH = "./models/base/encoder.h5".format(NEW)
DECODER_WEIGHTS_PATH = "./models/base/decoder.h5".format(NEW)
...
tb = keras.callbacks.TensorBoard(log_dir="./logs/base/image_classifier/".format(NEW))
'''
...
model_saver = ModelSaver(
    classifier=model.classifier, path="./models/base/image_classifier.h5".format(NEW)
)
