...
tb = keras.callbacks.TensorBoard(log_dir="./logs/Xray6/privacy_classifier_gender/".format(NEW))
'''
...
chkpnt = keras.callbacks.ModelCheckpoint(
    filepath="models/Xray6/privacy_classifier_gender.h5",
    monitor="val_auc",
    save_best_only=True,
    save_weights_only=True,
)
...
plt.savefig('Learning_Curve_Xray_img_classifer_genderprediction_6.png')
